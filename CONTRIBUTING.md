...
We welcome all contributions to trajectory_clustering!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/tramp037/trajectory_clustering/issues)
...
The second two options both involve making a [pull request](https://github.com/tramp037/trajectory_clustering/pulls) .
