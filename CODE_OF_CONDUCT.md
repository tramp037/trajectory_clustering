...
The trajectory_clustering *Code of Conduct* sets the rules for the behavior of
every member in the trajectory_clustering community so that everyone can
...
trajectory_clustering is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make trajectory_clustering a welcoming and productive community.
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and trajectory_clustering is no exception. It is important
   that we resolve disagreements and differing views constructively. Remember
   that we’re different. The strength of trajectory_clustering comes from its varied community
...
reported by contacting the project team at 'tramp037@umn.edu'. The project team will
...
modified by trajectory_clustering.
