...
import trajclustering  # noqa



# -- Project information -----------------------------------------------------

project = "trajectory_clustering"
copyright = (
    "2024, Naomi Trampe. "
...
htmlhelp_basename = "trajectory_clusteringdoc"
...
latex_documents = [
    (master_doc, "trajectory_clustering.tex", "trajectory_clustering Documentation",
     "trajectory_clustering", "manual"),
]
...
man_pages = [
    (master_doc, "trajectory_clustering", "trajectory_clustering Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "trajectory_clustering", "trajectory_clustering Documentation",
     author, "trajectory_clustering", "MDAKit for trajectory clustering",
     "Miscellaneous"),
]
